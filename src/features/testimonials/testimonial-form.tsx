    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <textarea
                ...
                placeholder="Partage ton expérience avec Blooprint..."
                maxLength={500}
                rows={3}
                required
                className="w-full rounded-lg border border-zinc-800 bg-zinc-900/80 px-4 py-3 text-sm text-white placeholder:text-zinc-600 focus:border-sky-400/40 focus:outline-none focus:ring-1 focus:ring-sky-400/20 resize-none"
            />
            ...
            <div className="flex items-center justify-between gap-4">
                ...
                <select
                    ...
                    className="rounded-lg border border-zinc-800 bg-zinc-900/80 px-3 py-2 text-xs text-zinc-300 focus:border-sky-400/40 focus:outline-none"
                >
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button
                        ...
                        size="sm"
                        className="bg-sky-400 text-zinc-950 hover:bg-sky-300 disabled:opacity-50"
                    >
                        {loading ? (
