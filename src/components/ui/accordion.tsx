...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn("rounded-xl border border-dashed border-zinc-700 bg-zinc-900/40 overflow-hidden", className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between p-5 text-sm font-medium text-white transition-colors hover:bg-zinc-900/60 text-left [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
