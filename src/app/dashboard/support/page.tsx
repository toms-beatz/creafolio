...
/**
 * US-1302 + US-1303 : Support dashboard utilisateur
 * ?view=new → Formulaire nouveau ticket
 * ?ticket=ID → Détail ticket + thread
 * Default → Liste tickets
 */
        ...
        return (
            <div className="space-y-6 max-w-3xl">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <span
                        className={`rounded-full border border-dashed px-2 py-0.5 font-mono text-[9px] uppercase tracking-widest ${st.color}`}
                    >
                        {st.label}
                    </span>
                </div>
                ...
                <div className="space-y-4">
                    {(messages ?? []).map((msg) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={`max-w-[80%] rounded-xl px-4 py-3 ${isAdmin
                                ...
                                >
                                    <p className="font-mono text-[9px] uppercase tracking-widest mb-1 opacity-60">
                                        {isAdmin ? "Blooprint Support" : "Vous"}
                                    </p>
                    ...
                    <div className="space-y-3">
                        <form action={replyToTicketAction}>
                            ...
                            <textarea
                                ...
                                minLength={2}
                                rows={3}
                                className="w-full rounded-lg border border-dashed border-zinc-800 bg-zinc-900 px-4 py-3 text-sm text-white placeholder-zinc-600 focus:border-sky-400/50 focus:outline-none transition-colors resize-none"
                                placeholder="Votre réponse..."
                            />
                            <Button
                                type="submit"
                                className="mt-2 bg-sky-400 text-zinc-950 hover:bg-sky-300"
                            >
                                Envoyer
                            </Button>
                        </form>
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Link href="/dashboard/support?view=new">
                    <Button className="bg-sky-400 text-zinc-950 hover:bg-sky-300">
                        Nouveau ticket
                    </Button>
                </Link>
            </div>
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-start justify-between gap-3">
                                    ...
                                    <span
                                        className={`shrink-0 rounded-full border border-dashed px-2 py-0.5 font-mono text-[9px] uppercase tracking-widest ${st.color}`}
                                    >
                                        {st.label}
                                    </span>
                                </div>
