 ...
 * Modifier username, changer mot de passe, supprimer compte.
 */
            ...
            <form action={action} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        className="w-full rounded-lg border border-dashed border-zinc-700 bg-zinc-900 px-4 py-2.5 text-sm text-white placeholder:text-zinc-600 focus:border-sky-500/50 focus:outline-none focus:ring-1 focus:ring-sky-500/20"
                    />
...
function PasswordSection() {
    ...
    return (
        <section className="rounded-xl border border-dashed border-zinc-700 bg-zinc-900/40 p-6">
            ...
            <form action={action} className="space-y-4">
                <div>
                    <label htmlFor="newPassword" className="block text-xs text-zinc-400 mb-1">
                ...
                <div>
                    <label htmlFor="confirmPassword" className="block text-xs text-zinc-400 mb-1">
