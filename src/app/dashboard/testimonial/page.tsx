...
export const metadata = {
    title: 'Mon témoignage — Blooprint',
};
        ...
        <div className="max-w-xl">
            ...
            <section className="rounded-xl border border-dashed border-zinc-700 bg-zinc-900/40 p-6">
                <div className="flex items-center gap-2 mb-5">
                    <Quote className="h-5 w-5 text-sky-400/60" />
                ...
                <div className="mt-5 pt-4 border-t border-dashed border-zinc-800">
                    <p className="text-[10px] text-zinc-600 leading-relaxed">
                        En soumettant ton avis, tu acceptes qu&apos;il soit publié sur la page d&apos;accueil de Blooprint
