...
export const metadata: Metadata = {
    ...
    description:
        'CGV de Blooprint — Conditions applicables aux abonnements Premium et aux paiements.',
};
            ...
            <main id="main-content" className="mx-auto max-w-3xl px-4 py-16">
                ...
                <div className="prose prose-invert prose-sm prose-zinc max-w-none space-y-8">
                    ...
                    <section>
                        ...
                        <p className="text-zinc-400 leading-relaxed">
                            ...
                            des abonnements payants (ci-après &quot;Abonnement Premium&quot;) proposés par Blooprint,
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-zinc-400 space-y-1.5">
                            <li><strong className="text-zinc-300">Dénomination :</strong> TOM$ (micro-entreprise).</li>
                            <li><strong className="text-zinc-300">Pays :</strong> France.</li>
                            <li><strong className="text-zinc-300">Contact :</strong>{' '}
                                <a href="mailto:hello@blooprint.fr" className="text-sky-400 hover:underline">hello@blooprint.fr</a>.
                            </li>
                            <li><strong className="text-zinc-300">TVA :</strong> Non applicable (article 293 B du CGI — régime micro-entreprise).</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-zinc-400 space-y-1.5">
                            ...
                            <li>Sous-domaine : blooprint.fr/username.</li>
                            <li>Templates de base.</li>
                            <li>Analytics de base (vues, visiteurs uniques).</li>
                            <li>Watermark Blooprint sur le portfolio.</li>
                        ...
                        <ul className="list-disc list-inside text-zinc-400 space-y-1.5">
                            ...
                            <li>Sans watermark Blooprint.</li>
                    ...
                    <section>
                            ...
                            <table className="w-full text-sm text-left" role="table">
                                <thead>
                                    <tr className="border-b border-zinc-800">
                                        <th className="py-2 pr-4 text-zinc-300 font-semibold">Formule</th>
                                        <th className="py-2 pr-4 text-zinc-300 font-semibold">Prix</th>
                                        <th className="py-2 text-zinc-300 font-semibold">Économie</th>
                                    </tr>
                                </thead>
                        ...
                        <ul className="list-disc list-inside text-zinc-400 space-y-2">
                            ...
                            <li>Blooprint se réserve le droit de modifier ses tarifs à tout moment. Les prix applicables sont ceux en vigueur au moment de la souscription.</li>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-zinc-400 space-y-2">
                            <li>À l&apos;inscription, chaque nouvel utilisateur bénéficie automatiquement de <strong className="text-zinc-300">7 jours d&apos;essai Premium gratuit</strong>.</li>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-zinc-400 space-y-1.5">
                            <li>L&apos;utilisateur choisit sa formule (mensuelle ou annuelle) depuis la page{' '}
                                <Link href="/pricing" className="text-sky-400 hover:underline">Pricing</Link> ou son Dashboard.</li>
                        ...
                        <ul className="list-disc list-inside text-zinc-400 space-y-1.5">
                            ...
                            <li>Les données de paiement ne sont jamais stockées sur les serveurs de Blooprint. Elles sont traitées exclusivement par Stripe (PCI-DSS Level 1).</li>
                        </ul>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-zinc-400 space-y-2">
                            <li><strong className="text-zinc-300">Par l&apos;utilisateur :</strong> l&apos;abonnement peut être résilié à tout moment via le Dashboard → Compte, ou en contactant hello@blooprint.fr. Aucun engagement de durée.</li>
                            <li><strong className="text-zinc-300">Par Blooprint :</strong> en cas de violation des CGU, de la{' '}
                                <Link href="/legal/charter" className="text-sky-400 hover:underline">Charte d&apos;utilisation</Link>,
                                ou en cas de fraude au paiement, Blooprint peut suspendre ou résilier l&apos;abonnement sans préavis.
                            </li>
                    ...
                    <section>
                        ...
                        <p className="text-zinc-400 leading-relaxed mb-3">
                            Toutefois, Blooprint propose une <strong className="text-zinc-200">garantie satisfait ou remboursé de 14 jours</strong> :
                        </p>
                        <ul className="list-disc list-inside text-zinc-400 space-y-1.5">
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-zinc-400 space-y-2">
                            <li>Blooprint s&apos;engage à fournir un service disponible et fonctionnel, mais ne garantit pas une disponibilité de 100 %.</li>
                            <li>En cas d&apos;interruption prolongée (plus de 72h) imputable à Blooprint, une extension de la période d&apos;abonnement équivalente sera accordée.</li>
                            <li>La responsabilité de Blooprint ne saurait excéder le montant total payé par l&apos;utilisateur au cours des 12 derniers mois.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-zinc-400 space-y-2">
                            <li>Les données de paiement sont traitées par{' '}
                                <a href="https://stripe.com/fr/privacy" target="_blank" rel="noopener noreferrer" className="text-sky-400 hover:underline">Stripe</a>,
                                certifié PCI-DSS Level 1.
                            </li>
                            <li>Blooprint ne stocke jamais les numéros de carte bancaire.</li>
                            ...
                            <li>Pour plus d&apos;informations, consultez notre{' '}
                                <Link href="/legal/privacy" className="text-sky-400 hover:underline">Politique de Confidentialité</Link>.
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-zinc-400 leading-relaxed mb-3">
                            En cas de litige, l&apos;utilisateur est invité à contacter Blooprint en premier lieu à{' '}
                            <a href="mailto:hello@blooprint.fr" className="text-sky-400 hover:underline">hello@blooprint.fr</a>{' '}
                        ...
                        <p className="text-zinc-400 leading-relaxed mb-3">
                            ...
                            amiable du litige. Blooprint mettra à disposition les informations du médiateur compétent
                            sur demande.
                        </p>
                        <p className="text-zinc-400 leading-relaxed">
                ...
                <div className="mt-12 pt-6 border-t border-dashed border-zinc-800 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 text-xs text-zinc-600">
                        ...
                        <Link href="/legal/charter" className="hover:text-zinc-400 transition-colors">Charte</Link>
