...
const FROM_EMAIL =
  process.env.SUPPORT_FROM_EMAIL || "Creafolio Support <support@creafolio.fr>";
...
${adminMessage}
        ...
        ${
          ticketUrl
            ? `<p style="margin-top: 24px;"><a href="${ticketUrl}" style="color: #38bdf8; font-size: 13px;">Voir mon ticket sur Creafolio →</a></p>`
        ...
        <div style="border-top: 1px dashed #27272a; padding-top: 16px; margin-top: 32px;">
          <p style="color: #52525b; font-size: 11px;">
            Creafolio — Le builder de portfolios pour créateurs UGC<br/>
            <a href="https://creafolio.fr" style="color: #52525b;">creafolio.fr</a>
          </p>
        </div>
      </div>
    `;
    ...
    await resend.emails.send({
      from: FROM_EMAIL,
      to,
      subject: `Re: ${ticketSubject} — Creafolio Support`,
      html: htmlBody,
      replyTo: "support@creafolio.fr",
    });
