...
export async function AnalyticsDashboardServer({ portfolios, isPremium }: Props) {
    ...
    if (portfolios.length > 1) {
        ...
        // Pour la vue globale, pas de tableau visiteurs (multi-portfolio)
        visitors['__global__'] = [];
    }
