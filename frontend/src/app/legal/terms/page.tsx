...
export const metadata: Metadata = {
    ...
    description:
        'CGU de Creafolio — Conditions d\'utilisation du service de création de portfolios UGC.',
};
                ...
                <div className="prose prose-sm prose-stone max-w-none space-y-8">
                    <section>
                        ...
                        <p className="text-[#1a1a1a]/70 leading-relaxed">
                            Creafolio est un service en ligne (SaaS) permettant aux créateurs de contenu UGC de
                    ...
                    <section>
                        ...
                        <p className="text-[#1a1a1a]/70 leading-relaxed">
                            Creafolio est édité par TOM$ (micro-entreprise, France).
                            Contact : <a href="mailto:hello@creafolio.fr" className="text-[#ad7b60] hover:underline">hello@creafolio.fr</a>.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-[#1a1a1a]/70 space-y-2">
                            <li><strong className="text-[#1a1a1a]/80">Free :</strong> 1 portfolio, 6 blocs maximum, analytics basiques, watermark Creafolio.</li>
                            <li><strong className="text-[#1a1a1a]/80">Premium :</strong> 11€/mois ou 79€/an. 3-5 portfolios, blocs illimités, analytics avancées, sans watermark.</li>
                            <li>Les paiements sont gérés par Stripe. L&apos;abonnement peut être annulé à tout moment sans engagement.</li>
                            <li>Remboursement : 14 jours satisfait ou remboursé, sans question. Écrivez à <a href="mailto:hello@creafolio.fr" className="text-[#ad7b60] hover:underline">hello@creafolio.fr</a>.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-[#1a1a1a]/70 leading-relaxed mt-3">
                            Creafolio se réserve le droit de suspendre tout portfolio signalé et contrevenant aux règles ci-dessus.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-[#1a1a1a]/70 space-y-2">
                            <li>Le service Creafolio (code, design, marque) est la propriété de TOM$.</li>
                            <li>Le contenu créé par l&apos;utilisateur lui appartient. Creafolio bénéficie d&apos;une licence d&apos;hébergement et d&apos;affichage pour le service.</li>
                    ...
                    <section>
                        ...
                        <p className="text-[#1a1a1a]/70 leading-relaxed">
                            Creafolio est fourni &quot;en l&apos;état&quot;. TOM$ ne saurait être tenu responsable de la
