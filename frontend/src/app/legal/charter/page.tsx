...
export const metadata: Metadata = {
    ...
    description:
        'Charte d\'utilisation et d\'éthique de Creafolio — Règles de contenu et limites applicables aux portfolios publiés.',
};
            ...
            <main id="main-content" className="mx-auto max-w-3xl px-4 py-16">
                ...
                <div className="prose prose-sm prose-stone max-w-none space-y-8">
                    ...
                    <section>
                        ...
                        <p className="text-[#1a1a1a]/70 leading-relaxed">
                            Creafolio est une plateforme de création de portfolios pour créateurs de contenu UGC (User Generated Content).
                            Les portfolios publiés via Creafolio sont accessibles publiquement sur Internet. Cette charte définit
                            ...
                            et les{' '}
                            <Link href="/legal/cgv" className="text-[#ad7b60] hover:underline">
                    ...
                    <section>
                        ...
                        <p className="text-[#1a1a1a]/70 leading-relaxed">
                            Tout contenu publié sur un portfolio Creafolio doit être <strong className="text-[#1a1a1a]/80">légal,
                                authentique, respectueux et professionnel</strong>. Creafolio se destine à la promotion professionnelle
                    ...
                    <section>
                        ...
                        <p className="text-[#1a1a1a]/70 leading-relaxed mb-3">
                            Les contenus suivants sont acceptés sur les portfolios Creafolio :
                        </p>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-[#1a1a1a]/70 space-y-2">
                            <li>
                                <strong className="text-[#1a1a1a]/80">Contenu beauté/fitness :</strong> accepté tant qu&apos;il reste professionnel et ne verse pas dans le contenu sexuellement suggestif.
                            </li>
                            <li>
                                <strong className="text-[#1a1a1a]/80">Promotions de produits de santé :</strong> autorisé si le contenu ne contient pas de fausses allégations médicales.
                            </li>
                            <li>
                                <strong className="text-[#1a1a1a]/80">Jeux d&apos;argent / paris :</strong> contenu de créateurs sponsorisés par des plateformes de paris autorisé uniquement si la législation locale du créateur le permet et que la mention &quot;publicité&quot; est clairement visible.
                            </li>
                            <li>
                                <strong className="text-[#1a1a1a]/80">Alcool / tabac :</strong> contenu sponsorisé accepté uniquement si conforme à la loi Évin et aux réglementations en vigueur.
                            </li>
                            <li>
                                <strong className="text-[#1a1a1a]/80">Cryptomonnaies / NFT :</strong> autorisé sans promesse de gain garanti, avec mention &quot;investissement à risque&quot;.
                            </li>
                            <li>
                                <strong className="text-[#1a1a1a]/80">Contenu politique :</strong> autorisé dans un cadre informatif et respectueux, sans propagande, désinformation ou incitation à la haine.
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-[#1a1a1a]/70 space-y-2">
                            ...
                            <li>Les statistiques affichées doivent être exactes et à jour. Creafolio se réserve le droit de demander une preuve.</li>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[#1a1a1a] border-b border-dashed border-[#e8c9b5] pb-2 mb-4">
                            <span className="inline-flex items-center gap-2">
                                <Scale className="h-4 w-4 text-[#ad7b60]" aria-hidden="true" />
                                6. Politique de modération
                            </span>
                        </h2>
                        ...
                        <ul className="list-disc list-inside text-[#1a1a1a]/70 space-y-1.5">
                            <li><strong className="text-[#1a1a1a]/80">Examen :</strong> chaque signalement est traité manuellement sous 48 heures ouvrées.</li>
                            <li><strong className="text-[#1a1a1a]/80">Avertissement :</strong> pour une première infraction mineure, un avertissement est envoyé avec 48h pour corriger.</li>
                            <li><strong className="text-[#1a1a1a]/80">Suspension :</strong> le portfolio est dépublié temporairement en cas d&apos;infraction grave ou de récidive.</li>
                            <li><strong className="text-[#1a1a1a]/80">Suppression :</strong> le portfolio et/ou le compte sont supprimés définitivement en cas d&apos;infraction majeure.</li>
                        </ul>
                            ...
                            <table className="w-full text-sm text-left" role="table">
                                <thead>
                                    <tr className="border-b border-[#e8c9b5]">
                                        <th className="py-2 pr-4 text-[#1a1a1a]/80 font-semibold">Infraction</th>
                                        <th className="py-2 pr-4 text-[#1a1a1a]/80 font-semibold">1ère fois</th>
                                        <th className="py-2 text-[#1a1a1a]/80 font-semibold">Récidive</th>
                                    </tr>
                                </thead>
                    ...
                    <section>
                        ...
                        <p className="text-[#1a1a1a]/70 leading-relaxed">
                            ...
                            La décision finale de Creafolio est définitive.
                        </p>
                    </section>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[#1a1a1a] border-b border-dashed border-[#e8c9b5] pb-2 mb-4">
                            8. Engagement éthique de Creafolio
                        </h2>
                        <p className="text-[#1a1a1a]/70 leading-relaxed mb-3">
                            De notre côté, Creafolio s&apos;engage à :
                        </p>
                        <ul className="list-disc list-inside text-[#1a1a1a]/70 space-y-2">
                ...
                <div className="mt-12 pt-6 border-t border-dashed border-[#e8c9b5] flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 text-xs text-zinc-600">
                        ...
                        <Link href="/legal/cgv" className="hover:text-[#1a1a1a]/70 transition-colors">CGV</Link>
